        ...
        <div >
          <div className="mx-auto  w-[28rem]  gap-1 rounded-lg border  border-gray-300 bg-white px-1 shadow-lg dark:bg-gray-900 profilecard" >
            <div className=" w-full items-center justify-center">
              <Image
                className="relative -top-[4rem] h-[10rem] w-[10rem] rounded-full shadow-lg outline outline-1 outline-offset-2 outline-blue-400"
                src="https://www.myfamilymg.com/images/providers/Steve.jpg"
                width={100}
                height={100}
                alt="Profile Image"
              />
        ...
        <div>
          ...
          >
            ...
            <div className="  w-full items-center justify-center">
              <Image
                className="relative -top-[4rem] h-[10rem] w-[10rem] rounded-full shadow-lg outline outline-1 outline-offset-2 outline-blue-400"
                src="https://www.myfamilymg.com/images/providers/Patel.jpg"
                width={100}
                height={100}
                alt="Profile Image"
              />
          ...
          >
            <div className="  w-full items-center justify-center">
              <Image
                ...
                src="https://www.myfamilymg.com/images/providers/Lira.jpg"
                width={100}
                height={100}
                alt="Profile Image"
              />
