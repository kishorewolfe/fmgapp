...
const ProfileNotFound = (props: Props) => {
  return (
    <div className="mt-[200px]">
      <div className="no-file-found flex flex-col items-center justify-center rounded-lg bg-gray-100 px-4 py-8 text-center shadow-md dark:bg-gray-800">
        <svg
        ...
        <h3 className="mt-4 text-xl font-medium text-gray-700 dark:text-gray-200">
          Profile Does Not Exist{" "}
        </h3>
        <p className="mt-2 text-gray-500 dark:text-gray-400">
          The Provider you are looking for could not be located.
        </p>
      </div>
    </div>
  );
