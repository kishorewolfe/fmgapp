...
const VideoPlayer = (props: Props) => {
  return (
    ...
    <div className=" absolute contents text-center " >
        ...
        <div className="">
            <a  href="tel:+909-591-6446" className='bg-transparent text-[15px] text-white hover:text-black
            uppercase lg:tracking-[0.5rem] transition-[0.25s] 
            duration-[background-color] mx-4 my-0 lg:px-10 p-4 border-solid border-2 sm:tracking-[0.3rem] hover:bg-white ;
'> (909) 591-6446</a>
        </div>
    </div>
    <video
        src={'/videos/sunset1.mp4'}
        autoPlay
        muted
        loop
        className={"video "}
