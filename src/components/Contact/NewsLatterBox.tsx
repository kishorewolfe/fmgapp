...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      My Family Medical Group is currently building a web portal for our physicians to verify eligibility, request and check status of authorizations, submit and check status of claims, and more.
      </p>
     <div>
     Additionally, we are also making more Provider Resources available on our homepage for more educational materials you need for your practice. Plese check back soon. For more immediate assistance please call us at (909)591-6446 from 8:00AM to 5:00PM on weekdays.
     </div>
